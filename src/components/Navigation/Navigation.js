...
const Navigation = ({loggedIn, handleCloseClick}) => {
  const location = useLocation();

  return (
    <nav className="navigation">
      <div className="navigation__item navigation__item_active" onClick={handleCloseClick}>
      ...
      <div className={loggedIn ? "navigation__item navigation__item_active" : "navigation__item"} onClick={handleCloseClick}>
